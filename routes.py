...
@router.post('/b_user/')
async def post_b_user( id: int, first_name: str, last_name: str, age: str , db: Session = Depends(get_db)):
    return await service.post_b_user(db , id, first_name, last_name, age)
